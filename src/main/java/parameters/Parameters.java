...
public final class Parameters {
    ...
    public static final float MAX_ACCEPTABLE_FIELD_VALUE = 2f;
    public static final float FIELD_POINT_VALUE = 10f;
    public static final float FIELD_NEIGHBOUR_VALUE = 1f;
    public static final float NOISE_SCALE = .01f;
    public static final Color BACKGROUND_COLOR = new Color(255);
    public static final Color STROKE_COLOR = new Color(0, 0, 25);
